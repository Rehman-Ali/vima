    ...
    <div className="container">
      <div className="breadcrumb-content">
        ...
        <ul>
          ...
          <li className="active">Story Details</li>
        </ul>
      </div>
    </div>
  </div>
    ...
    <div className="container-fluid custom-container">
      <div className="row">
        <div className="col-xl-9 col-lg-8">
          <div className="main-box padding-20 full-width sa-causes-single sa-causes-single-2">
            <div className="post-wrapper mb-xl-20">
              <div className="row">
                <div className="col-lg-6 col-md-6">
                  <div className="profile-img full-height">
                    <img src="assets/img/story-big/mainstory.jpg" alt="img" className="img-fluid full-width full-height" />
                  </div>
                </div>
                <div className="col-lg-6 col-md-6">
                  <div className="profile-content">
                    ...
                    <div className="bottom-group">
                      <a href="#" className="btn-solid with-line"><span>Donate Now <i className="fas fa-caret-right" /></span></a>
              ...
              <div className="col-12">
                ...
                <div className="user-gallery">
                  <div className="row">
                    <div className="col-md-3">
                      <a href="assets/img/story-big/storyg1.jpg" data-toggle="lightbox" data-gallery="gallery max-auto d-block">
                        <img src="assets/img/story-big/storyg8.jpg" className="img-fluid rounded mx-auto d-block full-width" />
                      </a>
                    </div>
                    <div className="col-md-3">
                      <a href="assets/img/story-big/storyg1.jpg" data-toggle="lightbox" data-gallery="gallery max-auto d-block">
                        <img src="assets/img/story-big/storyg7.jpg" className="img-fluid rounded mx-auto d-block full-width" />
                      </a>
                    </div>
                    <div className="col-md-3">
                      <a href="assets/img/story-big/storyg1.jpg" data-toggle="lightbox" data-gallery="gallery max-auto d-block">
                        <img src="assets/img/story-big/storyg6.jpg" className="img-fluid rounded mx-auto d-block full-width" />
                      </a>
                    </div>
                    <div className="col-md-3">
                      <a href="assets/img/story-big/storyg1.jpg" data-toggle="lightbox" data-gallery="gallery max-auto d-block">
                        <img src="assets/img/story-big/storyg5.jpg" className="img-fluid rounded mx-auto d-block full-width" />
                      </a>
                    </div>
                    <div className="col-md-3">
                      <a href="assets/img/story-big/storyg1.jpg" data-toggle="lightbox" data-gallery="gallery max-auto d-block">
                        <img src="assets/img/story-big/storyg4.jpg" className="img-fluid rounded mx-auto d-block full-width" />
                      </a>
                    </div>
                    <div className="col-md-3">
                      <a href="assets/img/story-big/storyg1.jpg" data-toggle="lightbox" data-gallery="gallery max-auto d-block">
                        <img src="assets/img/story-big/storyg3.jpg" className="img-fluid rounded mx-auto d-block full-width" />
                      </a>
                    </div>
                    <div className="col-md-3">
                      <a href="assets/img/story-big/storyg1.jpg" data-toggle="lightbox" data-gallery="gallery max-auto d-block">
                        <img src="assets/img/story-big/storyg2.jpg" className="img-fluid rounded mx-auto d-block full-width" />
                      </a>
                    </div>
                    <div className="col-md-3">
                      <a href="assets/img/story-big/storyg1.jpg" data-toggle="lightbox" data-gallery="gallery max-auto d-block">
                        <img src="assets/img/story-big/storyg1.jpg" className="img-fluid rounded mx-auto d-block full-width" />
                      </a>
                    </div>
                  </div>
                </div>
                ...
                <div className="comment-box">
                  ...
                  <div className="review-box">
                    <div className="review-user">
                      <div className="review-user-img">
                        <img src="assets/img/story-big/user.jpg" className="rounded-circle" alt="#" />
                  ...
                  <div className="review-box comment-reply">
                    <div className="review-user">
                      <div className="review-user-img">
                        <img src="assets/img/story-big/user2.jpg" className="rounded-circle" alt="#" />
                        <div className="reviewer-name">
                          <p className="text-light-black fw-600">Sarra </p>
                        </div>
                      </div>
                  ...
                  <div className="review-box">
                    <div className="review-user">
                      <div className="review-user-img">
                        <img src="assets/img/story-big/user1.jpg" className="rounded-circle" alt="#" />
                        <div className="reviewer-name">
                          <p className="text-light-black fw-600">Sarra</p>
                        </div>
                      </div>
        ...
        <aside className="col-xl-3 col-lg-4">
          <div className="side-bar mb-md-40">
              ...
              <article className="side-post pb-xl-20 mb-xl-20 u-line">
                ...
                <div className="content-wrap">
                  <div className="entry-meta-content">
                    ...
                    <div className="entry-tye"> <span className="text-light-white fw-400">Adem Rich</span>
                    </div>
                  </div>
                </div>
              </article>
              <article className="side-post pb-xl-20 mb-xl-20 u-line">
                ...
                <div className="content-wrap">
                  <div className="entry-meta-content">
                    ...
                    <div className="entry-tye"> <span className="text-light-white fw-400">Jim Lux</span>
                    </div>
                  </div>
                </div>
              </article>
              <article className="side-post pb-xl-20 mb-xl-20 u-line">
                ...
                <div className="content-wrap">
                  <div className="entry-meta-content">
                    ...
                    <div className="entry-tye"> <span className="text-light-white fw-400">Michle Rolls</span>
                    </div>
                  </div>
                </div>
              </article>
              <article className="side-post">
                ...
                <div className="content-wrap">
                  <div className="entry-meta-content">
                    ...
                    <div className="entry-tye"> <span className="text-light-white fw-400">Kim Lui</span>
                    </div>
                  </div>
                </div>
              </article>
            ...
            <div className="main-box padding-20 trending-blog-cat mb-xl-20">
              <h5 className="text-light-black">Archive</h5>
              <ul>
                <li className="pb-xl-20 u-line mb-xl-20"> <a href="#" className="text-light-black fw-600">2011 <span className="text-light-white fw-400">(110)</span></a>
                </li>
                <li className="pb-xl-20 u-line mb-xl-20"> <a href="#" className="text-light-black fw-600">2012 <span className="text-light-white fw-400">(98)</span></a>
                </li>
                <li className="pb-xl-20 u-line mb-xl-20"> <a href="#" className="text-light-black fw-600">2013 <span className="text-light-white fw-400">(52)</span></a>
                </li>
                <li className="pb-xl-20 u-line mb-xl-20"> <a href="#" className="text-light-black fw-600">2014 <span className="text-light-white fw-400">(26)</span></a>
                </li>
                <li className="pb-xl-20 u-line mb-xl-20"> <a href="#" className="text-light-black fw-600">2015 <span className="text-light-white fw-400">(55)</span></a>
                </li>
                <li className="pb-xl-20 u-line mb-xl-20"> <a href="#" className="text-light-black fw-600">2016 <span className="text-light-white fw-400">(48)</span></a>
                </li>
                <li className="pb-xl-20 u-line mb-xl-20"> <a href="#" className="text-light-black fw-600">2017 <span className="text-light-white fw-400">(50)</span></a>
                </li>
              </ul>
            </div>
          </div>
